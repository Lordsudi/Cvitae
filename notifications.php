...
<head>
	...
	<title>Light Bootstrap Dashboard by Cvitae</title>
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        ...
                        <p class="category">Handcrafted by <a target="_blank" href="https://github.com/mouse0270">SUDIPTO PAUL and ISHAAN JAISWAL</a>. Please checkout the <a href="http://bootstrap-notify.remabledesigns.com/" target="_blank">full documentation.</a></p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="alert alert-info alert-with-icon" data-notify="container">
                                    <button type="button" aria-hidden="true" class="close">×</button>
                                    <span data-notify="icon" class="pe-7s-bell"></span>
                                    <span data-notify="message">This is a beautiful notification. So you don't have to worry about the style.</span>
                                </div>
                            </div>
                            <div class="col-md-6">
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script> <a href="http://www.cvitae.com">..CVITAE..</a>, made for making better CV.
                </p>
            </div>
        </footer>
