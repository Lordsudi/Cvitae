...
<html>
<head>
	<title>PROJECTX|TESTSUBMISSION|SACHINKUMARSINGH</title>
...
<h2 style="margin-bottom: 40px">CODE AREA</h2>
                ...
                <div class="contact-form">
                    ...
                    <form id="contact-us" method="post" action="#">
                        ...
                        <div class="col-sm-6 wow animated slideInRight" data-wow-delay=".5s">
                            <!-- Message -->
                            <textarea name="message" id="message" class="form textarea"  placeholder="Type Your code Here"></textarea>
                        </div><!-- End Right Inputs -->
                        <!-- Bottom Submit -->
                        <div class="relative fullwidth col-xs-12">
                            <!-- Send Button -->
                            <button type="submit code" id="submit" name="submit" class="form-btn semibold">submit code</button> 
...
<center> <p style="padding-top: 30px">Click to submit code.</p> </center>
</section>
</section>
